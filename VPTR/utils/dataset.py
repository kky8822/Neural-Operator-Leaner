...
def get_dataloader(
    ...
    if data_set_name == "KTH":
        ...
        # # channels: data_w, data_w0, data_f, data_ux, data_uy, data_uxy, data_v
        # mean = (
        #     -2.59000000e-03,
        #     -2.59000000e-03,
        #     -1.19333333e-04,
        ...
        #     0.81649658,
        # )
        # min = (-7.45e00, -7.45e00, -1.41e-01, -1.21e02, -1.26e02, -5.68e03, -4.00e00)
        # max = (7.66e00, 7.66e00, 1.41e-01, 1.20e02, 1.15e02, 5.59e03, -2.00e00)
        ...
        if transform_norm == "mean_std":
            ...
            renorm_transform = transforms.Compose(
                [
                    VidReNormalize(
                        mean=mean[0:pred_channels], std=std[0:pred_channels]
                    ),
                    VidMinMax(min=min[0:pred_channels], max=max[0:pred_channels]),
                ]
            )
            ...
            test_transform = None
            renorm_transform = VidMinMax(
                min=min[0:pred_channels], max=max[0:pred_channels]
            )
