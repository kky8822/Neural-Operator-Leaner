...
class SpectralConv3d_fast(nn.Module):
    def __init__(self, in_channels, out_channels, num_layer, num_hidden, symbol_act, net_out):
        ...
        self.net_real = Net(d_in=3, d_out=in_channels * out_channels, num_layer=num_layer, num_hidden=num_hidden, act=symbol_act)
        self.net_imag = Net(d_in=3, d_out=in_channels * out_channels, num_layer=num_layer, num_hidden=num_hidden, act=symbol_act)
        if net_out:
            self.net_out = Net(d_in=3, d_out=in_channels * out_channels, num_layer=num_layer, num_hidden=num_hidden, act=symbol_act)
...
class NS(nn.Module):
    def __init__(self, width, symbol_act, use_last=False, num_layer=2, num_hidden=32, net_out=True):
        ...
        self.conv0 = SpectralConv3d_fast(self.width, self.width, num_layer=num_layer, num_hidden=num_hidden, symbol_act=symbol_act, net_out=net_out)
        self.conv1 = SpectralConv3d_fast(self.width, self.width, num_layer=num_layer, num_hidden=num_hidden, symbol_act=symbol_act, net_out=net_out)
        self.conv2 = SpectralConv3d_fast(self.width, self.width, num_layer=num_layer, num_hidden=num_hidden, symbol_act=symbol_act, net_out=net_out)
        self.conv3 = SpectralConv3d_fast(self.width, self.width, num_layer=num_layer, num_hidden=num_hidden, symbol_act=symbol_act, net_out=net_out)
