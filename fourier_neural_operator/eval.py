...
TEST_PATH = './PDE_datasets/ns_data_V1e-4_N20_T50_R256test.mat'
...
# load model
model = torch.load('./model/pretrained/ns_fourier_V1e-4_T20_N9800_ep200_m12_w32')
print(torchsummary.summary(model, (20,64,64,10)))
